(function(Keyboard) {
   ...
   */
  Keyboard.KeyMap = function(keyboard) {
   ...
   */
  Keyboard.KeyMap.prototype.addKeyDef = function(keyCode, def) {
   ...
   */
  Keyboard.KeyMap.prototype.addKeyDefs = function(var_args) {
   ...
   */
  Keyboard.KeyMap.prototype = {
    __proto__: Keyboard.KeyMap.prototype
  };

  /**
   * Set up the default state for this keymap.
   */
  Keyboard.KeyMap.prototype.reset = function() {
    this.keyDefs = {};
    ...
    var CANCEL = Keyboard.KeyActions.CANCEL;
    var DEFAULT = Keyboard.KeyActions.DEFAULT;
    var PASS = Keyboard.KeyActions.PASS;
    var STRIP = Keyboard.KeyActions.STRIP;
   ...
   */
  Keyboard.KeyMap.prototype.onKeyInsert_ = function(e) {
    if (e.shiftKey)
      return Keyboard.KeyActions.PASS;
    return '\x1b[2~';
  };
   ...
   */
  Keyboard.KeyMap.prototype.onKeyHome_ = function(e) {
    if (!e.shiftKey) {
    ...
    return Keyboard.KeyActions.CANCEL;
  };

  /**
   * Either scroll the scrollback buffer or send a key sequence.
   */
  Keyboard.KeyMap.prototype.onKeyEnd_ = function(e) {
    if (!e.shiftKey) {
   ...
   * Either scroll the scrollback buffer or send a key sequence.
   */
  Keyboard.KeyMap.prototype.onKeyPageUp_ = function(e) {
    if (!e.shiftKey)
      return '\x1b[5~';
   ...
   * Either scroll the scrollback buffer or send a key sequence.
   */
  Keyboard.KeyMap.prototype.onKeyPageDown_ = function(e) {
    if (!e.shiftKey)
      return '\x1b[6~';
   ...
   * the key again.
   */
  Keyboard.KeyMap.prototype.onCtrlC_ = function(e, keyDef) {
   ...
   */
  Keyboard.KeyMap.prototype.onCtrlN_ = function(e, keyDef) {
    if (e.shiftKey) {
   ...
   */
  Keyboard.KeyMap.prototype.onMetaN_ = function(e, keyDef) {
    if (e.shiftKey) {
      window.open(document.location.href, '',
          'chrome=no,close=yes,resize=yes,scrollbars=yes,' +
    ...
    return Keyboard.KeyActions.DEFAULT;
  };
   ...
   */
  Keyboard.KeyMap.prototype.onMetaC_ = function(e, keyDef) {
   ...
   * avoid the issue.
   */
  Keyboard.KeyMap.prototype.onZoom_ = function(e, keyDef) {
