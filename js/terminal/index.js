...
(function(hterm, TerminalIO, DefaultPreference, ScrollPort, Screen, VT, Options, Keyboard, Size, f, colors) {
  'use strict';
   ...
   *
   * @param {string} preference Custom preference object to override the default
   *    preference.
   */
  var Terminal = function(preference) {
    // preference object of the terminal
    this.prefs_ = DefaultPreference();
   ...
   */
  Terminal.prototype.scrollbarWidthPx = 16;

  /**
   * Set terminal preferences
   *
   * @param {string} preference the preference object that will override default
   *     preference
   */
  Terminal.prototype.setPreference = function() {
  ...
  Terminal.prototype.runCommandClass = function(commandClass, argString) {
    var environment = this.prefs_['environment'];
    ...
    this.command = new commandClass(
      ...
      onExit: function(code) {
        self.io.pop();
        self.io.println('COMMAND_COMPLETE');
