...
(function(hterm, PubSub, Size) {
   ...
   */
  ScrollPort.prototype.setSelectionEnabled = function(state) {
  ...
  ScrollPort.prototype.measureCharacterSize = function(opt_weight) {
    ...
    var size = new Size(this.ruler_.clientWidth,
   ...
   */
  ScrollPort.prototype.onMouseDown_ = function(e) {
    if (e.which == 1 && !this.selectionEnabled_) {
      e.preventDefault();
    }
  };

  hterm.ScrollPort = ScrollPort;
})(hterm, hterm.PubSub, hterm.Size);
